...
//
//  Assemblies:
//    GTANetworkShared.dll
//
//****************************************************************



declare module GTANetworkShared {

    export class Attachment {
        NetHandle: number;
        PositionOffset: GTANetworkShared.Vector3;
        RotationOffset: GTANetworkShared.Vector3;
        Bone: string;
        constructor();
    }
    ...
    export class ConnectionResponse {
        ...
        Settings: GTANetworkShared.SharedSettings;
    ...
    export class CreateEntity {
        NetHandle: number;
        EntityType: number;
        Properties: GTANetworkShared.EntityProperties;
        constructor();
    }
    ...
    export class Delta_MarkerProperties {
        Direction: GTANetworkShared.Vector3;
        //MarkerType?: number;
		MarkerType: number;
        //Red?: number;
		Red: number;
        ...
        //Blue?: number;
		Blue: number;
        Scale: GTANetworkShared.Vector3;
        constructor();
    }
    ...
    export class Delta_VehicleProperties {
        ...
        //TraileredBy?: number;
		TraileredBy: number;
        DamageModel: GTANetworkShared.VehicleDamageModel;
        constructor();
    }
    ...
    export class FileDeclaration {
        type: GTANetworkShared.FileType;
        path: string;
        hash: string;
        constructor(_path: string, _hash: string, _type: GTANetworkShared.FileType);
    }
    ...
    export class ListArgument {
        Data: GTANetworkShared.NativeArgument[];
        constructor();
    }
    ...
    export class Movement {
        Duration: number;
        Start: number;
        StartVector: GTANetworkShared.Vector3;
        EndVector: GTANetworkShared.Vector3;
    ...
    export class NativeData {
        Hash: number;
        Arguments_: GTANetworkShared.NativeArgument[];
        ReturnType: GTANetworkShared.NativeArgument;
        Id: number;
        constructor();
    }

    export class NativeResponse {
        Response: GTANetworkShared.NativeArgument;
        Id: number;
        constructor();
    }

    export class NativeTickCall {
        Native: GTANetworkShared.NativeData;
        Identifier: string;
        constructor();
    }
    ...
    export class PacketOptimization {
        static WritePureSync(data: GTANetworkShared.PedData): any;
        static WriteLightSync(data: GTANetworkShared.PedData): any;
        static WritePureSync(data: GTANetworkShared.VehicleData): any;
        static WriteLightSync(data: GTANetworkShared.VehicleData): any;
        static WriteBasicSync(netHandle: number, position: GTANetworkShared.Vector3): any;
        static WriteBulletSync(netHandle: number, shooting: boolean, aimCoords: GTANetworkShared.Vector3): any;
        static WriteUnOccupiedVehicleSync(data: GTANetworkShared.VehicleData): any;
        static WriteBasicUnOccupiedVehicleSync(data: GTANetworkShared.VehicleData): any;
        static ReadPurePedSync(array: any): GTANetworkShared.PedData;
        static ReadLightPedSync(array: any): GTANetworkShared.PedData;
        static ReadPureVehicleSync(array: any): GTANetworkShared.VehicleData;
        static ReadLightVehicleSync(array: any): GTANetworkShared.VehicleData;
        //static ReadBasicSync(array: any, netHandle: number&, position: GTANetworkShared.Vector3&): void;
        static ReadBasicSync(array: any, netHandle: number, position: GTANetworkShared.Vector3): void;
        //static ReadBulletSync(array: any, netHandle: number&, position: GTANetworkShared.Vector3&): boolean;
        static ReadBulletSync(array: any, netHandle: number, position: GTANetworkShared.Vector3): boolean;
        static ReadUnoccupiedVehicleSync(array: any): GTANetworkShared.VehicleData;
        static ReadBasicUnoccupiedVehicleSync(array: any): GTANetworkShared.VehicleData;
        static CompressSingle(value: number): number;
        static DecompressSingle(value: number): number;
        static CheckBit(value: number, flag: GTANetworkShared.VehicleDataFlags): boolean;
        static CheckBit(value: number, flag: GTANetworkShared.PedDataFlags): boolean;
        static CheckBit(value: number, flag: GTANetworkShared.EntityFlag): boolean;
        static SetBit(value: number, flag: GTANetworkShared.EntityFlag): number;
        static ResetBit(value: number, flag: GTANetworkShared.EntityFlag): number;
    ...
    export class ParseableVersion {
        ...
        ToString(): string;
        CompareTo(right: GTANetworkShared.ParseableVersion): number;
        CreateComparableInteger(): number;
        ToLong(): number;
        static FromLong(version: number): GTANetworkShared.ParseableVersion;
        static Parse(version: string): GTANetworkShared.ParseableVersion;
        static FromAssembly(): GTANetworkShared.ParseableVersion;
        //static FromAssembly(assembly: System.Reflection.Assembly): GTANetworkShared.ParseableVersion;
        static FromAssembly(assembly: any): GTANetworkShared.ParseableVersion;
    }
    ...
    export class PedData {
        ...
        //PedModelHash?: number;
		PedModelHash: number;
        Quaternion: GTANetworkShared.Vector3;
        AimCoords: GTANetworkShared.Vector3;
        //WeaponHash?: number;
		WeaponHash: number;
        //PlayerHealth?: number;
		PlayerHealth: number;
        ...
        //Flag?: number;
		Flag: number;
        Velocity: GTANetworkShared.Vector3;
    ...
    export class ScriptCollection {
        ClientsideScripts: GTANetworkShared.ClientsideScript[];
        constructor();
    }
    ...
    export class ServerMap {
        ...
        Peds: number[];
        Particles: number[];
        World: GTANetworkShared.WorldProperties;
        constructor();
    }
    ...
    export class ServerSettings {
        ...
        Password: string;
        MasterServer: string;
        Resources: GTANetworkShared.ServerSettings_SettingsResFilepath[];
        UseACL: boolean;
        LogToFile: boolean;
        ...
        LocalAddress: string;
        whitelist: GTANetworkShared.WhitelistCollection;
        constructor();
        static ReadSettings(path: string): GTANetworkShared.ServerSettings;
        static WriteSettings(path: string, sett: GTANetworkShared.ServerSettings): void;
    }
    ...
    export class UpdateEntity {
        NetHandle: number;
        EntityType: number;
        Properties: GTANetworkShared.Delta_EntityProperties;
        constructor();
    }
    ...
    export class Vector3 {
        ...
        Y: number;
        Z: number;
        Normalized: GTANetworkShared.Vector3;
        constructor(x: number, y: number, z: number);
        constructor(x: number, y: number, z: number);
        constructor();
        static Lerp(start: GTANetworkShared.Vector3, end: GTANetworkShared.Vector3, n: number): GTANetworkShared.Vector3;
        ToString(): string;
        LengthSquared(): number;
        Length(): number;
        Normalize(): void;
        Add(right: GTANetworkShared.Vector3): GTANetworkShared.Vector3;
        Subtract(right: GTANetworkShared.Vector3): GTANetworkShared.Vector3;
        Multiply(right: number): GTANetworkShared.Vector3;
        Divide(right: number): GTANetworkShared.Vector3;
        static RandomXY(): GTANetworkShared.Vector3;
        Around(distance: number): GTANetworkShared.Vector3;
        DistanceToSquared(right: GTANetworkShared.Vector3): number;
        DistanceTo(right: GTANetworkShared.Vector3): number;
        DistanceToSquared2D(right: GTANetworkShared.Vector3): number;
        DistanceTo2D(right: GTANetworkShared.Vector3): number;
    }
    ...
    export class VehicleData {
        ...
        //Steering?: number;
		Steering: number;
        Trailer: GTANetworkShared.Vector3;
        DamageModel: GTANetworkShared.VehicleDamageModel;
        constructor();
    }
    ...
    export class VersionCompatibility {
        LastCompatibleClientVersion: GTANetworkShared.ParseableVersion;
        LastCompatibleServerVersion: GTANetworkShared.ParseableVersion;
    }
    ...
    export class WhitelistCollection {
        Items: GTANetworkShared.WhitelistItem[];
        constructor();
    }
