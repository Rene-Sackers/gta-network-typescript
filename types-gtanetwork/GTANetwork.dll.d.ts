...
declare namespace GTANetwork.Javascript {
    ...
    class ScriptContext {
        ...
        worldToScreenMaintainRatio(pos: Vector3): System.Drawing.PointF;
        getCurrentResourceName(): string;
        screenToWorld(pos: System.Drawing.PointF): Vector3;
        screenToWorldMaintainRatio(pos: System.Drawing.PointF): Vector3;
        screenToWorld(pos: System.Drawing.PointF, camPos: Vector3, camRot: Vector3): Vector3;
        screenToWorldMaintainRatio(pos: System.Drawing.PointF, camPos: Vector3, camrot: Vector3): Vector3;
        ...
        setEntityCollisionless(entity: GTANetwork.Util.LocalHandle, status: boolean): void;
        ...
        setEntityPosition(ent: GTANetwork.Util.LocalHandle, pos: Vector3, ground?: boolean): void;
        ...
        playScreenEffect(effectName: string, duration: number, looped: boolean);
        playPoliceReport(effectName: string, duration: number, looped: boolean);
        ...
        getScreenResolutionAccurate(): System.Drawing.Size;
        ...
        setBlipRouteVisible(blip: GTANetwork.Util.LocalHandle, visible: boolean);
        getBlipRouteVisible(blip: GTANetwork.Util.LocalHandle);
        setBlipRouteColor(blip: GTANetwork.Util.LocalHandle, color: number);
        getBlipRouteColor(blip: GTANetwork.Util.LocalHandle): number;
        ...
        getGameText(name: string): string;
        getGroundHeight(position: Vector3): number;
        getPlayerSeatbelt(player: GTANetwork.Util.LocalHandle): number;
        ...
        createMenu(title: string, subtitle: string, x: number, y: number, anchor: Enums.MenuAnchor, enableBanner?: boolean): NativeUI.UIMenu;
